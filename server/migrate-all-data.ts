...
// Migration already executed — user data removed from source code for security.
// To re-run, populate USERS_DATA manually from a secure export before executing.
