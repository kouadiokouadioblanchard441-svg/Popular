                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 flex-wrap mb-1">
                            ...
                            <Badge variant={!sp.isActive ? "secondary" : scheduled ? "outline" : "default"} className={scheduled ? "border-gray-400 text-gray-600" : ""}>
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <div className="text-right">
                        ...
                        {s.status === "released" && s.releasedAt && (
                          <p className="text-xs text-gray-600 font-medium">Libéré le {formatDate(s.releasedAt)}</p>
                        )}
                      </div>
                    </div>
                  </CardContent>
