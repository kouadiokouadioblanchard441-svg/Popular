...
const fr: Translations = {
    ...
    purchaseSuccessDescription: "Votre premier gain est disponible immédiatement après l'achat. Collectez-le dans Revenu, puis collectez un nouveau gain toutes les 24 heures.",
    ...
    ordersDateLbl:      "Date",
    investConfirmDesc:  "Après l'achat, votre premier gain est disponible immédiatement. Collectez-le dans Revenu, puis collectez un nouveau gain toutes les 24 heures.",
    ...
    myProductsEarnings: "Mes revenus",
     myProductsSettledEvery24h: "⏱️ Le premier gain est disponible après l'achat, puis les gains se collectent toutes les 24 heures dans Revenu",
...
const ENGLISH_PHRASES: Record<string, string> = {
  ...
  "Votre premier gain est disponible dès l'achat. Collectez vos gains dans Revenu toutes les 24 heures": "Your first earning is available after purchase. Collect earnings in Revenue every 24 hours",
...
const STATIC_UI_TRANSLATIONS: StaticTranslationRow[] = [
  ...
  ["Le premier gain est disponible après l'achat, puis les gains se collectent toutes les 24 heures dans Revenu", "The first earning is available after purchase, then collect earnings every 24 hours in Revenue", "يتوفر الربح الأول بعد الشراء، ثم اجمع الأرباح كل 24 ساعة من قسم الأرباح", "购买后即可领取第一笔收益，之后每24小时在“收益”页面领取"],
