...
export default function CompanyPage() {
  ...
  return (
    <div className="min-h-screen pb-6" style={{ background: "#000000" }}>
      <header className="flex items-center px-4 py-3" style={{ background: "#ffffff" }}>
        <Link href="/">
          <button className="p-1" data-testid="button-company-back" aria-label="Retour">
            <ChevronLeft className="w-6 h-6 text-black" />
          </button>
        </Link>
        <h1 className="flex-1 text-center text-lg font-semibold text-black pr-8">{pageTitle}</h1>
      </header>
