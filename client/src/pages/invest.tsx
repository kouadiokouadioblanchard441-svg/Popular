          ...
          >
            ...
            <div className="px-5 py-3 text-center">
              ...
              <p style={{ fontSize: 12, color: "#888", marginTop: 3, lineHeight: 1.5 }}>
                {lang === "en"
                  ? "You can buy multiple devices to increase your earnings"
            ...
            >
              {[
                { value: `${confirmProduct.cycleDays} ${t.ordersDaysLbl}`, label: t.period },
                { value: `${currency} ${Number(confirmProduct.dailyEarnings).toLocaleString()}`, label: t.dailyRevenue },
                { value: `${currency} ${Number(confirmProduct.totalReturn).toLocaleString()}`, label: t.totalRevenue },
              ].map((stat, i) => (
                <div
                  key={i}
