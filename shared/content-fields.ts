...
export const CONTENT_GROUPS: ContentGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "content_orders_infoLine1", label: "Texte d'information 1", defaultValue: "Les revenus du produit sont crédités automatiquement selon le cycle défini sur sa fiche.", multiline: true },
